...
from data_set import Ct, LunaDataset
matplotlib.use('nbagg')

clim = (-1000.0, 300)


# TODO: Useless, remove or move to another file
...
def showCandidate(series_uid, batch_ndx=None, **kwargs):
    ...
    :return:
    """
    ds = LunaDataset(series_uid=series_uid, **kwargs)  # get dataset for sample in a sigle ct scan
